           ...
           <SimpleGrid width={"80%"}  columns={[1,2,3]} spacing="30px" paddingBottom={"30px"}>
            <Box>
              ...
              <SimpleGrid marginTop={"10px"} columns="3" spacing="5px">
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray" ><Link to="timetracker" smooth={true} duration={500}>Time Tracker</Link></Button>
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray"><Link to="kisok" smooth={true} duration={500}>Kiosk</Link></Button>
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray"><Link to="apps" smooth={true} duration={500}>Apps</Link></Button>
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray"><Link to="timesheet" smooth={true} duration={500}>Time Sheet</Link></Button>
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray"><Link to="calender" smooth={true} duration={500}>Calender</Link></Button>
                   <Button fontWeight={"normal"}  size='md' _hover={{bg:"blue.400",color:"white"}} color="black" colorScheme="gray"><Link to="interagation" smooth={true} duration={500}>Integrations</Link></Button>
              </SimpleGrid>
            </Box>
            <Box>
